...
var G__27982 = null;
var G__27982__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$2(this$,k);
});
var G__27982__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$3(this$,k,not_found);
});
...
;
jQuery.prototype.apply = (function (self__,args27981){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args27981)));
});
...
var hide__delegate = function ($elem,p__27983){var vec__27985 = p__27983;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27985,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27985,1,null);return $elem.hide(speed,on_finish);
};
...
var show__delegate = function ($elem,p__27987){var vec__27989 = p__27987;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27989,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27989,1,null);return $elem.show(speed,on_finish);
};
...
var toggle__delegate = function ($elem,p__27991){var vec__27993 = p__27991;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27993,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27993,1,null);return $elem.toggle(speed,on_finish);
};
...
var fade_out__delegate = function ($elem,p__27995){var vec__27997 = p__27995;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27997,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27997,1,null);return $elem.fadeOut(speed,on_finish);
};
...
var fade_in__delegate = function ($elem,p__27999){var vec__28001 = p__27999;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28001,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28001,1,null);return $elem.fadeIn(speed,on_finish);
};
...
var slide_up__delegate = function ($elem,p__28003){var vec__28005 = p__28003;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28005,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28005,1,null);return $elem.slideUp(speed,on_finish);
};
...
var slide_down__delegate = function ($elem,p__28007){var vec__28009 = p__28007;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28009,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28009,1,null);return $elem.slideDown(speed,on_finish);
};
...
var closest__delegate = function ($elem,selector,p__28011){var vec__28013 = p__28011;var context = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28013,0,null);return $elem.closest(jayq.core.__GT_selector(selector),context);
};
...
jQuery.ajaxSetup(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$427,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$430,"application/edn, text/edn",cljs.core.constant$keyword$431,"application/clojure, text/clojure"], null),cljs.core.constant$keyword$428,new cljs.core.PersistentArrayMap(null, 1, ["clojure",/edn|clojure/], null),cljs.core.constant$keyword$429,new cljs.core.PersistentArrayMap(null, 2, ["text edn",jayq.core.mimetype_converter,"text clojure",jayq.core.mimetype_converter], null)], null)));
...
jayq.core.preprocess_request = (function preprocess_request(p__28017){var map__28019 = p__28017;var map__28019__$1 = ((cljs.core.seq_QMARK_(map__28019))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28019):map__28019);var request = map__28019__$1;var contentType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28019__$1,cljs.core.constant$keyword$432);var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28019__$1,cljs.core.constant$keyword$433);var ct = jayq.core.__GT_content_type(contentType);return (function (p1__28016_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_(ct)))
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__28016_SHARP_,cljs.core.constant$keyword$433,cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([data], 0)));
} else
{return p1__28016_SHARP_;
}
}).call(null,(function (p1__28015_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__28015_SHARP_,cljs.core.constant$keyword$432,ct);
} else
...
;
jayq.core.xhr = (function xhr(p__28020,content,callback){var vec__28022 = p__28020;var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28022,0,null);var uri = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28022,1,null);var params = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$317,clojure.string.upper_case(cljs.core.name(method)),cljs.core.constant$keyword$433,cljs.core.clj__GT_js(content),cljs.core.constant$keyword$434,callback], null));return jQuery.ajax(uri,params);
});
/**
...
var unbind__delegate = function ($elem,ev,p__28023){var vec__28025 = p__28023;var func = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28025,0,null);return $elem.unbind(cljs.core.name(ev),func);
};
...
var on__delegate = function ($elem,events,p__28027){var vec__28029 = p__28027;var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28029,0,null);var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28029,1,null);var handler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28029,2,null);return $elem.on(jayq.core.__GT_event(events),jayq.core.__GT_selector(sel),data,handler);
};
...
var one__delegate = function ($elem,events,p__28031){var vec__28033 = p__28031;var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28033,0,null);var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28033,1,null);var handler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28033,2,null);return $elem.one(jayq.core.__GT_event(events),jayq.core.__GT_selector(sel),data,handler);
};
...
var off__delegate = function ($elem,events,p__28035){var vec__28037 = p__28035;var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,0,null);var handler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,1,null);return $elem.off(jayq.core.__GT_event(events),jayq.core.__GT_selector(sel),handler);
};
...
var offset = null;
var offset__1 = (function ($elem){return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic($elem.offset(),cljs.core.array_seq([cljs.core.constant$keyword$279,true], 0));
});
...
jayq.core.position = (function position($elem){return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic($elem.position(),cljs.core.array_seq([cljs.core.constant$keyword$279,true], 0));
});
...
jayq.core.deferred_m = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$435,jayq.core.$when,cljs.core.constant$keyword$436,(function (x,f){var dfd = (jayq.core.$deferred.cljs$core$IFn$_invoke$arity$0 ? jayq.core.$deferred.cljs$core$IFn$_invoke$arity$0() : jayq.core.$deferred.call(null));jayq.core.done.cljs$core$IFn$_invoke$arity$variadic(x,cljs.core.array_seq([(function (v){return jayq.core.done.cljs$core$IFn$_invoke$arity$variadic((f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v)),cljs.core.array_seq([cljs.core.partial.cljs$core$IFn$_invoke$arity$2(jayq.core.resolve,dfd)], 0));
})], 0));
return jayq.core.promise.cljs$core$IFn$_invoke$arity$1(dfd);
}),cljs.core.constant$keyword$437,cljs.core.identity], null);
jayq.core.ajax_m = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$435,cljs.core.identity,cljs.core.constant$keyword$436,(function (x,f){return jayq.core.done.cljs$core$IFn$_invoke$arity$variadic(jayq.core.ajax.cljs$core$IFn$_invoke$arity$1(x),cljs.core.array_seq([f], 0));
}),cljs.core.constant$keyword$437,cljs.core.identity], null);
