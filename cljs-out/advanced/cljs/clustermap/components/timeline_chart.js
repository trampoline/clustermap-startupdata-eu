...
goog.require('clustermap.formats.number');
goog.require('jayq.core');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__34584){var map__34586 = p__34584;var map__34586__$1 = ((cljs.core.seq_QMARK_(map__34586))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34586):map__34586);var opts = map__34586__$1;var y1_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34586__$1,cljs.core.constant$keyword$705);var y0_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34586__$1,cljs.core.constant$keyword$706);var x_labels = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$707,data);var stats = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$708,data);var y_median = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(((function (x_labels,stats){
...
return (function (p1__34579_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__34579_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$708,cljs.core.constant$keyword$709], null));
});})(x_labels,stats))
...
return (function (p1__34581_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__34581_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$708,cljs.core.constant$keyword$684], null));
});})(x_labels,stats,y_median))
...
return (function (p1__34583_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__34583_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$708,cljs.core.constant$keyword$679], null));
});})(x_labels,stats,y_median,y_mean))
),data);return jayq.core.$.cljs$core$IFn$_invoke$arity$1(node).highcharts(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$710,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$715,null,cljs.core.constant$keyword$716,300], null),cljs.core.constant$keyword$711,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$717,null], null),cljs.core.constant$keyword$712,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$718,x_labels,cljs.core.constant$keyword$719,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$720,270], null)], null),cljs.core.constant$keyword$713,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$711,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$717,y0_title], null),cljs.core.constant$keyword$721,0,cljs.core.constant$keyword$719,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$722,(function (){var this$ = this;return clustermap.formats.money.readable.cljs$core$IFn$_invoke$arity$variadic(this$.value,cljs.core.array_seq([cljs.core.constant$keyword$628,""], 0));
})], null)], null)], null),cljs.core.constant$keyword$714,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [cljs.core.constant$keyword$594,[cljs.core.str("Total "),cljs.core.str(y0_title)].join(''),cljs.core.constant$keyword$584,"line",cljs.core.constant$keyword$713,0,cljs.core.constant$keyword$700,y_total], null)], null)], null)));
});
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,p__34587){var map__34592 = p__34587;var map__34592__$1 = ((cljs.core.seq_QMARK_(map__34592))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34592):map__34592);var opts = map__34592__$1;var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34592__$1,cljs.core.constant$keyword$580);if(typeof clustermap.components.timeline_chart.t34593 !== 'undefined')
{} else
{
/**
* @constructor
