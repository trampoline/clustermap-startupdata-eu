...
goog.require('clustermap.formats.time');
goog.require('clustermap.formats.number');
clustermap.components.full_report.company_site_list.investment = (function investment(investment__$1,owner,p__33875){var map__33884 = p__33875;var map__33884__$1 = ((cljs.core.seq_QMARK_(map__33884))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33884):map__33884);var opts = map__33884__$1;var path_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33884__$1,cljs.core.constant$keyword$632);var link_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33884__$1,cljs.core.constant$keyword$650);var company_path = (path_fn.cljs$core$IFn$_invoke$arity$2 ? path_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$629,investment__$1) : path_fn.call(null,cljs.core.constant$keyword$629,investment__$1));if(typeof clustermap.components.full_report.company_site_list.t33885 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;return React.DOM.tr(null,(function (){var attrs33888 = cljs.core.constant$keyword$651.cljs$core$IFn$_invoke$arity$1(self__.investment);if(cljs.core.map_QMARK_(attrs33888))
...
})(),(function (){var attrs33889 = cljs.core.constant$keyword$652.cljs$core$IFn$_invoke$arity$1(self__.investment);if(cljs.core.map_QMARK_(attrs33889))
...
})(),(function (){var attrs33890 = (self__.link_fn.cljs$core$IFn$_invoke$arity$2 ? self__.link_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$630,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$653,cljs.core.constant$keyword$653.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$594,cljs.core.constant$keyword$654.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)) : self__.link_fn.call(null,cljs.core.constant$keyword$630,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$653,cljs.core.constant$keyword$653.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$594,cljs.core.constant$keyword$654.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)));if(cljs.core.map_QMARK_(attrs33890))
...
})(),(function (){var attrs33891 = (self__.link_fn.cljs$core$IFn$_invoke$arity$2 ? self__.link_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$631,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$655,cljs.core.constant$keyword$655.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$656,cljs.core.constant$keyword$657.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)) : self__.link_fn.call(null,cljs.core.constant$keyword$631,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$655,cljs.core.constant$keyword$655.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$656,cljs.core.constant$keyword$657.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)));if(cljs.core.map_QMARK_(attrs33891))
...
clustermap.components.full_report.company_site_list.company_site_list = (function company_site_list(investments,owner,opts){var comm = om.core.get_shared.cljs$core$IFn$_invoke$arity$2(owner,cljs.core.constant$keyword$633);if(typeof clustermap.components.full_report.company_site_list.t33906 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;var attrs33909 = clustermap.components.table.paginate(self__.comm,self__.investments,cljs.core.constant$keyword$658);if(cljs.core.map_QMARK_(attrs33909))
{return React.DOM.div(sablono.interpreter.attributes(sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$574,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["full-report-list"], null)], null),attrs33909], 0))),React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,(function (){var attrs33910 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Investor-backed Company",cljs.core.constant$keyword$659);if(cljs.core.map_QMARK_(attrs33910))
...
})(),(function (){var attrs33911 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Postcode",cljs.core.constant$keyword$660);if(cljs.core.map_QMARK_(attrs33911))
...
})(),(function (){var attrs33912 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Investor",cljs.core.constant$keyword$572);if(cljs.core.map_QMARK_(attrs33912))
...
})(),(function (){var attrs33913 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Constituency",cljs.core.constant$keyword$571);if(cljs.core.map_QMARK_(attrs33913))
...
})())),(function (){var attrs33914 = om.core.build_all.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.company_site_list.investment,cljs.core.constant$keyword$661.cljs$core$IFn$_invoke$arity$1(self__.investments),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$617,cljs.core.constant$keyword$662,cljs.core.constant$keyword$620,self__.opts], null));if(cljs.core.map_QMARK_(attrs33914))
...
})(),(function (){var attrs33916 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Postcode",cljs.core.constant$keyword$660);if(cljs.core.map_QMARK_(attrs33916))
...
})(),(function (){var attrs33917 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Investor",cljs.core.constant$keyword$572);if(cljs.core.map_QMARK_(attrs33917))
...
})(),(function (){var attrs33918 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$658,"Constituency",cljs.core.constant$keyword$571);if(cljs.core.map_QMARK_(attrs33918))
...
})())),(function (){var attrs33919 = om.core.build_all.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.company_site_list.investment,cljs.core.constant$keyword$661.cljs$core$IFn$_invoke$arity$1(self__.investments),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$617,cljs.core.constant$keyword$662,cljs.core.constant$keyword$620,self__.opts], null));if(cljs.core.map_QMARK_(attrs33919))
