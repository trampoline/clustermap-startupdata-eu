...
var this__9251__auto____$1 = this;return React.DOM.tr(null,(function (){var attrs33827 = (self__.link_fn.cljs$core$IFn$_invoke$arity$2 ? self__.link_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$629,self__.company) : self__.link_fn.call(null,cljs.core.constant$keyword$629,self__.company));if(cljs.core.map_QMARK_(attrs33827))
...
})(),(function (){var attrs33828 = clustermap.components.full_report.company_list.render_many_links(self__.link_fn,self__.company_path,cljs.core.constant$keyword$630,cljs.core.constant$keyword$685.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.map_QMARK_(attrs33828))
...
})(),(function (){var attrs33829 = clustermap.components.full_report.company_list.render_many_links(self__.link_fn,self__.company_path,cljs.core.constant$keyword$631,(function (){var G__33834 = self__.company;var G__33834__$1 = (((G__33834 == null))?null:cljs.core.constant$keyword$686.cljs$core$IFn$_invoke$arity$1(G__33834));var G__33834__$2 = (((G__33834__$1 == null))?null:cljs.core.filter(((function (G__33834,G__33834__$1){
...
})(),(function (){var attrs33830 = (clustermap.formats.money.fmoney.cljs$core$IFn$_invoke$arity$5 ? clustermap.formats.money.fmoney.cljs$core$IFn$_invoke$arity$5(cljs.core.constant$keyword$570.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$625,2,cljs.core.constant$keyword$541,"-") : clustermap.formats.money.fmoney.call(null,cljs.core.constant$keyword$570.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$625,2,cljs.core.constant$keyword$541,"-"));if(cljs.core.map_QMARK_(attrs33830))
{return React.DOM.td(sablono.interpreter.attributes(attrs33830),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$688.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
...
{return React.DOM.td(null,sablono.interpreter.interpret(attrs33830),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$688.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "no info";
}
...
})(),(function (){var attrs33831 = clustermap.components.full_report.company_list.pos_neg(cljs.core.constant$keyword$689.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.map_QMARK_(attrs33831))
...
})(),(function (){var attrs33833 = (clustermap.formats.number.fnum.cljs$core$IFn$_invoke$arity$5 ? clustermap.formats.number.fnum.cljs$core$IFn$_invoke$arity$5(cljs.core.constant$keyword$690.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$627,0,cljs.core.constant$keyword$541,"-") : clustermap.formats.number.fnum.call(null,cljs.core.constant$keyword$690.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$627,0,cljs.core.constant$keyword$541,"-"));if(cljs.core.map_QMARK_(attrs33833))
{return React.DOM.td(sablono.interpreter.attributes(attrs33833),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$688.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "no info";
}
...
{return React.DOM.td(null,sablono.interpreter.interpret(attrs33833),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$688.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "no info";
}
...
clustermap.components.full_report.company_list.company_list = (function company_list(companies,owner,opts){var comm = om.core.get_shared.cljs$core$IFn$_invoke$arity$2(owner,cljs.core.constant$keyword$633);if(typeof clustermap.components.full_report.company_list.t33855 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;var attrs33858 = clustermap.components.table.paginate(self__.comm,self__.companies,cljs.core.constant$keyword$691);if(cljs.core.map_QMARK_(attrs33858))
{return React.DOM.div(sablono.interpreter.attributes(sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$574,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["full-report-list"], null)], null),attrs33858], 0))),React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,(function (){var attrs33859 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Investor-backed company",cljs.core.constant$keyword$594);if(cljs.core.map_QMARK_(attrs33859))
...
})(),React.DOM.th(null,"Investor"),React.DOM.th(null,"Constituency"),(function (){var attrs33864 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Revenue",cljs.core.constant$keyword$570);if(cljs.core.map_QMARK_(attrs33864))
...
})(),React.DOM.th({"colSpan": "2"},sablono.interpreter.interpret(clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Rev. change",cljs.core.constant$keyword$689))),(function (){var attrs33865 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Employees",cljs.core.constant$keyword$690);if(cljs.core.map_QMARK_(attrs33865))
...
})())),(function (){var attrs33866 = om.core.build_all.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.company_list.portfolio_company,cljs.core.constant$keyword$661.cljs$core$IFn$_invoke$arity$1(self__.companies),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$617,cljs.core.constant$keyword$692,cljs.core.constant$keyword$620,self__.opts], null));if(cljs.core.map_QMARK_(attrs33866))
...
{return React.DOM.div({"className": "full-report-list"},sablono.interpreter.interpret(attrs33858),React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,(function (){var attrs33867 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Investor-backed company",cljs.core.constant$keyword$594);if(cljs.core.map_QMARK_(attrs33867))
...
})(),React.DOM.th(null,"Investor"),React.DOM.th(null,"Constituency"),(function (){var attrs33872 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Revenue",cljs.core.constant$keyword$570);if(cljs.core.map_QMARK_(attrs33872))
...
})(),React.DOM.th({"colSpan": "2"},sablono.interpreter.interpret(clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Rev. change",cljs.core.constant$keyword$689))),(function (){var attrs33873 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$691,"Employees",cljs.core.constant$keyword$690);if(cljs.core.map_QMARK_(attrs33873))
...
})())),(function (){var attrs33874 = om.core.build_all.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.company_list.portfolio_company,cljs.core.constant$keyword$661.cljs$core$IFn$_invoke$arity$1(self__.companies),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$617,cljs.core.constant$keyword$692,cljs.core.constant$keyword$620,self__.opts], null));if(cljs.core.map_QMARK_(attrs33874))
