...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3441__auto__ = cljs.core.some((function (p__22847){var vec__22848 = p__22847;var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22848,0,null);var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22848,1,null);if(cljs.core.truth_((function (){var and__3429__auto__ = z;if(cljs.core.truth_(and__3429__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.cljs$core$IFn$_invoke$arity$variadic(boundaryline_id,tolerance,cljs.core.array_seq([cljs.core.constant$keyword$298,true], 0));var use_korks = ((cljs.core.sequential_QMARK_(korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5562__auto__ = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1(1);cljs.core.async.impl.dispatch.run((function (){var f__5563__auto__ = (function (){var switch__5547__auto__ = (function (state_22868){var state_val_22869 = (state_22868[1]);if((state_val_22869 === 2))
...
})();var inst_22866 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app_state,cljs.core.update_in,path,inst_22865);var state_22868__$1 = state_22868;return cljs.core.async.impl.ioc_helpers.return_chan(state_22868__$1,inst_22866);
} else
{if((state_val_22869 === 1))
{var state_22868__$1 = state_22868;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_22868__$1,2,comm);
} else
{return null;
}
}
...
var result__5550__auto__ = switch__5547__auto__(state_22868);if(cljs.core.keyword_identical_QMARK_(result__5550__auto__,cljs.core.constant$keyword$284))
{{
continue;
}
} else
...
cljs.core.async.impl.ioc_helpers.process_exception(state_22868);
...
})();var state__5564__auto__ = (function (){var statearr_22876 = (f__5563__auto__.cljs$core$IFn$_invoke$arity$0 ? f__5563__auto__.cljs$core$IFn$_invoke$arity$0() : f__5563__auto__.call(null));(statearr_22876[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5562__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__22879){var map__22881 = p__22879;var map__22881__$1 = ((cljs.core.seq_QMARK_(map__22881))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22881):map__22881);var min_zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22881__$1,cljs.core.constant$keyword$306);if(cljs.core.truth_((function (){var and__3429__auto__ = min_zoom;if(cljs.core.truth_(and__3429__auto__))
