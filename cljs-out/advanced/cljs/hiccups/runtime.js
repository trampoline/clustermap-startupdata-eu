...
hiccups.runtime._STAR_html_mode_STAR_ = cljs.core.constant$keyword$426;
hiccups.runtime.xml_mode_QMARK_ = (function xml_mode_QMARK_(){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(hiccups.runtime._STAR_html_mode_STAR_,cljs.core.constant$keyword$426);
});
...
hiccups.runtime.render_attribute = (function render_attribute(p__28147){var vec__28149 = p__28147;var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28149,0,null);var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28149,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__28150){var vec__28153 = p__28150;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28153,0,null);var content = cljs.core.nthnext(vec__28153,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else
{}
var vec__28154 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$313,id,cljs.core.constant$keyword$307,(cljs.core.truth_(class$)?clojure.string.replace(class$,"."," "):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__28156 = hiccups.runtime.normalize_element(element);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28156,0,null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28156,1,null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28156,2,null);if(cljs.core.truth_((function (){var or__3441__auto__ = content;if(cljs.core.truth_(or__3441__auto__))
