...
domina.events.create_listener_function = (function create_listener_function(f){return (function (evt){(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1((function (){if(typeof domina.events.t28192 !== 'undefined')
{} else
{
/**
* @constructor
...
domina.events.t28192.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write(writer__4009__auto__,"domina.events/t28192");
});
...
})()) : f.call(null,(function (){if(typeof domina.events.t28192 !== 'undefined')
{} else
{
/**
* @constructor
...
var temp__4092__auto__ = cljs.core.seq(s__28200__$1);if(temp__4092__auto__)
{var s__28200__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_(s__28200__$2))
{var c__4156__auto__ = cljs.core.chunk_first(s__28200__$2);var size__4157__auto__ = cljs.core.count(c__4156__auto__);var b__28202 = cljs.core.chunk_buffer(size__4157__auto__);if((function (){var i__28201 = 0;while(true){
if((i__28201 < size__4157__auto__))
{var node = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4156__auto__,i__28201);cljs.core.chunk_append(b__28202,(cljs.core.truth_(once)?goog.events.listenOnce(node,t,f,capture):goog.events.listen(node,t,f,capture)));
{
...
{return cljs.core.chunk_cons(cljs.core.chunk(b__28202),iter__28199(cljs.core.chunk_rest(s__28200__$2)));
} else
{return cljs.core.chunk_cons(cljs.core.chunk(b__28202),null);
}
} else
{var node = cljs.core.first(s__28200__$2);return cljs.core.cons((cljs.core.truth_(once)?goog.events.listenOnce(node,t,f,capture):goog.events.listen(node,t,f,capture)),iter__28199(cljs.core.rest(s__28200__$2)));
}
} else
{return null;
}
...
var unlisten_BANG___1 = (function (content){var seq__28212 = cljs.core.seq(domina.nodes(content));var chunk__28213 = null;var count__28214 = 0;var i__28215 = 0;while(true){
if((i__28215 < count__28214))
{var node = chunk__28213.cljs$core$IIndexed$_nth$arity$2(null,i__28215);goog.events.removeAll(node);
{
...
{var temp__4092__auto__ = cljs.core.seq(seq__28212);if(temp__4092__auto__)
{var seq__28212__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_(seq__28212__$1))
{var c__4189__auto__ = cljs.core.chunk_first(seq__28212__$1);{
var G__28224 = cljs.core.chunk_rest(seq__28212__$1);
var G__28225 = c__4189__auto__;
var G__28226 = cljs.core.count(c__4189__auto__);
var G__28227 = 0;
seq__28212 = G__28224;
...
{var node = cljs.core.first(seq__28212__$1);goog.events.removeAll(node);
{
var G__28228 = cljs.core.next(seq__28212__$1);
var G__28229 = null;
var G__28230 = 0;
var G__28231 = 0;
seq__28212 = G__28228;
...
var unlisten_BANG___2 = (function (content,type){var type__$1 = cljs.core.name(type);var seq__28216 = cljs.core.seq(domina.nodes(content));var chunk__28217 = null;var count__28218 = 0;var i__28219 = 0;while(true){
if((i__28219 < count__28218))
{var node = chunk__28217.cljs$core$IIndexed$_nth$arity$2(null,i__28219);goog.events.removeAll(node,type__$1);
{
...
{var temp__4092__auto__ = cljs.core.seq(seq__28216);if(temp__4092__auto__)
{var seq__28216__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_(seq__28216__$1))
{var c__4189__auto__ = cljs.core.chunk_first(seq__28216__$1);{
var G__28236 = cljs.core.chunk_rest(seq__28216__$1);
var G__28237 = c__4189__auto__;
var G__28238 = cljs.core.count(c__4189__auto__);
var G__28239 = 0;
seq__28216 = G__28236;
...
{var node = cljs.core.first(seq__28216__$1);goog.events.removeAll(node,type__$1);
{
var G__28240 = cljs.core.next(seq__28216__$1);
var G__28241 = null;
var G__28242 = 0;
var G__28243 = 0;
seq__28216 = G__28240;
...
var G__28244 = parent;
var G__28245 = cljs.core.cons(parent,so_far);
n = G__28244;
so_far = G__28245;
continue;
}
...
*/
domina.events.dispatch_browser_BANG_ = (function dispatch_browser_BANG_(source,evt){var ancestors = domina.events.ancestor_nodes.cljs$core$IFn$_invoke$arity$1(domina.single_node(source));var seq__28254_28262 = cljs.core.seq(ancestors);var chunk__28255_28263 = null;var count__28256_28264 = 0;var i__28257_28265 = 0;while(true){
if((i__28257_28265 < count__28256_28264))
{var n_28266 = chunk__28255_28263.cljs$core$IIndexed$_nth$arity$2(null,i__28257_28265);if(cljs.core.truth_(evt.propagationStopped_))
{} else
...
{var temp__4092__auto___28271 = cljs.core.seq(seq__28254_28262);if(temp__4092__auto___28271)
{var seq__28254_28272__$1 = temp__4092__auto___28271;if(cljs.core.chunked_seq_QMARK_(seq__28254_28272__$1))
{var c__4189__auto___28273 = cljs.core.chunk_first(seq__28254_28272__$1);{
var G__28274 = cljs.core.chunk_rest(seq__28254_28272__$1);
var G__28275 = c__4189__auto___28273;
var G__28276 = cljs.core.count(c__4189__auto___28273);
var G__28277 = 0;
...
{var n_28278 = cljs.core.first(seq__28254_28272__$1);if(cljs.core.truth_(evt.propagationStopped_))
{} else
{evt.currentTarget = n_28278;
goog.events.fireListeners(n_28278,evt.type,true,evt);
}
{
var G__28279 = cljs.core.next(seq__28254_28272__$1);
var G__28280 = null;
var G__28281 = 0;
var G__28282 = 0;
...
var seq__28258_28283 = cljs.core.seq(cljs.core.reverse(ancestors));var chunk__28259_28284 = null;var count__28260_28285 = 0;var i__28261_28286 = 0;while(true){
if((i__28261_28286 < count__28260_28285))
{var n_28287 = chunk__28259_28284.cljs$core$IIndexed$_nth$arity$2(null,i__28261_28286);if(cljs.core.truth_(evt.propagationStopped_))
{} else
...
{var temp__4092__auto___28292 = cljs.core.seq(seq__28258_28283);if(temp__4092__auto___28292)
{var seq__28258_28293__$1 = temp__4092__auto___28292;if(cljs.core.chunked_seq_QMARK_(seq__28258_28293__$1))
{var c__4189__auto___28294 = cljs.core.chunk_first(seq__28258_28293__$1);{
var G__28295 = cljs.core.chunk_rest(seq__28258_28293__$1);
var G__28296 = c__4189__auto___28294;
var G__28297 = cljs.core.count(c__4189__auto___28294);
var G__28298 = 0;
...
{var n_28299 = cljs.core.first(seq__28258_28293__$1);if(cljs.core.truth_(evt.propagationStopped_))
{} else
{evt.currentTarget = n_28299;
goog.events.fireListeners(n_28299,evt.type,false,evt);
}
{
var G__28300 = cljs.core.next(seq__28258_28293__$1);
var G__28301 = null;
var G__28302 = 0;
var G__28303 = 0;
...
var dispatch_BANG___3 = (function (source,type,evt_map){var evt = (new goog.events.Event(cljs.core.name(type)));var seq__28310_28316 = cljs.core.seq(evt_map);var chunk__28311_28317 = null;var count__28312_28318 = 0;var i__28313_28319 = 0;while(true){
if((i__28313_28319 < count__28312_28318))
{var vec__28314_28320 = chunk__28311_28317.cljs$core$IIndexed$_nth$arity$2(null,i__28313_28319);var k_28321 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28314_28320,0,null);var v_28322 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28314_28320,1,null);(evt[k_28321] = v_28322);
{
...
{var temp__4092__auto___28327 = cljs.core.seq(seq__28310_28316);if(temp__4092__auto___28327)
{var seq__28310_28328__$1 = temp__4092__auto___28327;if(cljs.core.chunked_seq_QMARK_(seq__28310_28328__$1))
{var c__4189__auto___28329 = cljs.core.chunk_first(seq__28310_28328__$1);{
var G__28330 = cljs.core.chunk_rest(seq__28310_28328__$1);
var G__28331 = c__4189__auto___28329;
var G__28332 = cljs.core.count(c__4189__auto___28329);
var G__28333 = 0;
...
{var vec__28315_28334 = cljs.core.first(seq__28310_28328__$1);var k_28335 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28315_28334,0,null);var v_28336 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28315_28334,1,null);(evt[k_28335] = v_28336);
{
var G__28337 = cljs.core.next(seq__28310_28328__$1);
var G__28338 = null;
var G__28339 = 0;
var G__28340 = 0;
...
*/
domina.events.get_listeners = (function get_listeners(content,type){var type__$1 = cljs.core.name(type);return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__28341_SHARP_){return goog.events.getListeners(p1__28341_SHARP_,type__$1,false);
