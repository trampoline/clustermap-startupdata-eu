...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){var dom_attrs = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.zipmap(cljs.core.keys(attrs),cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.camelcase_key,cljs.core.keys(attrs))),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$307,cljs.core.constant$keyword$309,cljs.core.constant$keyword$308,cljs.core.constant$keyword$310], null)], 0));return clojure.set.rename_keys(attrs,dom_attrs);
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__27962_SHARP_){if(cljs.core.list_QMARK_(p1__27962_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__27962_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__27962_SHARP_))
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$307,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$307,classes);
}
};
...
*/
sablono.util.normalize_element = (function normalize_element(p__27964){var vec__27967 = p__27964;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27967,0,null);var content = cljs.core.nthnext(vec__27967,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str(tag),cljs.core.str(" is not a valid element name.")].join(''),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$311,tag,cljs.core.constant$keyword$312,content], null));
} else
{}
var vec__27968 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27968,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27968,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27968,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27968,3,null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$313,id,cljs.core.constant$keyword$307,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
sablono.util.react_fn = (function react_fn(tag){var dom_fn = sablono.util.react_symbol(tag);if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$314,null,cljs.core.constant$keyword$315,null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag)))
