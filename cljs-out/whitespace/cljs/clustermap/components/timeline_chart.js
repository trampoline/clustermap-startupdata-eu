...
goog.require('clustermap.formats.number');
goog.require('jayq.core');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__34584){var map__34586 = p__34584;var map__34586__$1 = ((cljs.core.seq_QMARK_.call(null,map__34586))?cljs.core.apply.call(null,cljs.core.hash_map,map__34586):map__34586);var opts = map__34586__$1;var y1_title = cljs.core.get.call(null,map__34586__$1,new cljs.core.Keyword(null,"y1-title","y1-title",3377247893));var y0_title = cljs.core.get.call(null,map__34586__$1,new cljs.core.Keyword(null,"y0-title","y0-title",2489744212));var x_labels = cljs.core.map.call(null,new cljs.core.Keyword(null,"date","date",1016980256),data);var stats = cljs.core.map.call(null,new cljs.core.Keyword(null,"stats","stats",1123661841),data);var y_median = cljs.core.map.call(null,cljs.core.comp.call(null,((function (x_labels,stats){
return (function (p1__34578_SHARP_){return clustermap.formats.number.round_decimal.call(null,p1__34578_SHARP_,0);
});})(x_labels,stats))
,((function (x_labels,stats){
return (function (p1__34579_SHARP_){return cljs.core.get_in.call(null,p1__34579_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stats","stats",1123661841),new cljs.core.Keyword(null,"median","median",4230840444)], null));
});})(x_labels,stats))
),data);var y_mean = cljs.core.map.call(null,cljs.core.comp.call(null,((function (x_labels,stats,y_median){
return (function (p1__34580_SHARP_){return clustermap.formats.number.round_decimal.call(null,p1__34580_SHARP_,0);
});})(x_labels,stats,y_median))
,((function (x_labels,stats,y_median){
return (function (p1__34581_SHARP_){return cljs.core.get_in.call(null,p1__34581_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stats","stats",1123661841),new cljs.core.Keyword(null,"mean","mean",1017251639)], null));
});})(x_labels,stats,y_median))
),data);var y_total = cljs.core.map.call(null,cljs.core.comp.call(null,((function (x_labels,stats,y_median,y_mean){
return (function (p1__34582_SHARP_){return clustermap.formats.number.round_decimal.call(null,p1__34582_SHARP_,0);
});})(x_labels,stats,y_median,y_mean))
,((function (x_labels,stats,y_median,y_mean){
return (function (p1__34583_SHARP_){return cljs.core.get_in.call(null,p1__34583_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stats","stats",1123661841),new cljs.core.Keyword(null,"total","total",1124454070)], null));
});})(x_labels,stats,y_median,y_mean))
...
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,p__34587){var map__34592 = p__34587;var map__34592__$1 = ((cljs.core.seq_QMARK_.call(null,map__34592))?cljs.core.apply.call(null,cljs.core.hash_map,map__34592):map__34592);var opts = map__34592__$1;var id = cljs.core.get.call(null,map__34592__$1,new cljs.core.Keyword(null,"id","id",1013907597));if(typeof clustermap.components.timeline_chart.t34593 !== 'undefined')
{} else
{
/**
* @constructor
...
clustermap.components.timeline_chart.t34593.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"clustermap.components.timeline-chart/t34593");
});
